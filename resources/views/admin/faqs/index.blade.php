    ...
    @isset($faq)    
        ...
        @component('admin.components.locale', ['tab' => 'content'])
            ...
            @foreach ($localizations as $localization)
                ...
                <form class="admin-form faq {{ $loop->first ? 'activo':'' }}" class="faqs-form" action="{{route("faqs_store")}}" autocomplete="off">
                    ...
                    <div class="modify-form" style="opacity: 0">
                        <div class ="submit">            
                        ...
                        <div class="erase">
                            <button class="new-form" data-url="{{route('faqs_create')}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus-fill" viewBox="0 0 16 16">
