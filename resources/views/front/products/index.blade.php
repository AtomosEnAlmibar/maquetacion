...
<div class="product">
    <div class="gallery">
        ...
        <div class="grid">
            <div class="grid-image">
                <img src="https://misanimales.com/wp-content/uploads/2019/06/sanguijuela-medicinal-hirudo-medicinalis.jpg">
            </div>
            <div class="grid-image">
                <img src="https://inaturalist-open-data.s3.amazonaws.com/photos/58921718/original.jpg?1577976661">
            </div>
            <div class="grid-image">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSX5p4PnQ_cz62VX6Kca4yo8fRK-cRWweVNZQ&usqp=CAU">
            </div>
        </div>
    </div>
    <div class="product-details">
        ...
        <div class="common-name">
            <h3>Common Name:</h3>
            <span>European medicinal leech</span>
        </div>
        ...
        <div class="buy">
            <div class="buy-item">
                <button class="buy-now"><span>Buy now</span></button>
            </div>
            <div class="buy-item">
